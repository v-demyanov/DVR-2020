...
namespace Error
{
	ERROR errors[ERROR_MAX_ENTRY] =
	{
		...
		ERROR_ENTRY(200, "Îøèáêà: ïåğåîïğåäåëåíèå èäåíòèôèêàòîğà"),					// +
		ERROR_ENTRY(201, "Îøèáêà: èäåíòèôèêàòîğ íå îïğåäåë¸í, íî èñïîëüçóåòñÿ"),	// +
		ERROR_ENTRY(202, "Îøèáêà: âñå îïåğàíäû â âûğàæåíèÿõ è îïåğàöèÿõ äîëæíû èìåòü òèïû, äîïóñòèìûå äëÿ äàííîãî âûğàæåíèÿ èëè îïåğàöèè"),
		ERROR_ENTRY(203, "Îøèáêà: êîëè÷åñòâî èëè òèïû ôàêòè÷åñêèõ ïàğàìåòğîâ íå ñîãëàñîâàíû ñ êîëè÷åñòâîì èëè òèïàìè ôîğìàëüíûõ ïàğàìåòğîâ"),
		ERROR_ENTRY(204, "Îøèáêà: òèï âîçâğàùàåìîãî çíà÷åíèÿ ôóíêöèè"),				// +
